...
<head>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=<?php echo esc_attr($dostart_google_analytics_id); ?>"></script> <?php // phpcs:ignore ?>
    <script>
    ...
    <!-- Google Adsense Code -->
    <script data-ad-client="ca-<?php echo esc_attr($dostart_google_adsense_publisher_id); ?>" async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>  <?php // phpcs:ignore ?>
    <!-- Google Adsense Code -->
    <?php } ?>
