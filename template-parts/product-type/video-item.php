...
if ( $youtube_video ) { ?>
	...
	<div class="plyr__video-embed" id="digicart-player">
		<iframe
...
<div class="video-item">
	<video poster="<?php echo wp_get_attachment_image_src( get_post_thumbnail_id( get_the_ID() ), 'digicart-1280x720' )[0]; ?>" id="digicart-player" controls>
		<source src="<?php echo esc_url( $video ); ?>" type="video/mp4" />
		<source src="<?php echo esc_url( $video ); ?>" type="video/webm" />
	</video>
	<a class="view-detail" href="<?php the_permalink(); ?>"><?php echo esc_html__( 'View detail', 'digicart' ); ?></a>
</div>
