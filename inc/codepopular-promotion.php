...
if ( ! function_exists( 'codepopular_add_dashboard_widgets' ) ) {
	...
	function codepopular_add_dashboard_widgets() {
		...
		add_meta_box( 'codepopular_latest_news_dashboard_widget', __( 'CodePopular Latest News from Blog', 'dostart' ), 'codepopular_dashboard_widget_render', 'dashboard', 'side', 'high' );
...
if ( ! function_exists( 'codepopular_dashboard_widget_render' ) ) {
	...
	function codepopular_dashboard_widget_render() {
		...
		if ( ! empty( $posts ) ) {
			...
			<hr>
			<p>
                <a style="text-decoration: none;font-weight: bold" href="<?php echo esc_url( 'https://codepopular.com/blog/' ); ?>" target=_balnk>
                    <?php echo esc_html__( 'Get more WordPress tips & news on our blog...', 'dostart' ); ?>
                </a>
            </p>
			<p>
                <a style="text-decoration: none; font-weight: bold; color: #fff; border: 1px solid #ccc; padding: 6px 10px; border-radius: 4px; background: #39b54a; " href="<?php echo esc_url( 'https://codepopular.com/contact' ); ?>" target=_balnk>
                    <?php echo esc_html__( 'Hire Me', 'dostart' ); ?>
                </a>
            </p>
			<?php
		}
