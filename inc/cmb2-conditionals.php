...
if ( ! class_exists( 'digicart_CMB2_Conditionals', false ) ) {

	/**
	 * digicart_CMB2_Conditionals Plugin.
	 */
	class digicart_CMB2_Conditionals {
		...
		public function admin_footer() {
			...
			$enqueue_script = apply_filters( 'digicart_CMB2_Conditionals_enqueue_script', $enqueue_script );

			// possibility to change script source
			$script_src = apply_filters( 'digicart_CMB2_Conditionals_enqueue_script_src', get_template_directory_uri() . '/assets/js/admin/cmb2-conditionals.js' );
	...
	if ( ( function_exists( 'wp_installing' ) && wp_installing() === false ) || ( ! function_exists( 'wp_installing' ) && ( ! defined( 'WP_INSTALLING' ) || WP_INSTALLING === false ) ) ) {
		add_action( 'init', 'digicart_CMB2_Conditionals_init' );
	}

	if ( ! function_exists( 'digicart_CMB2_Conditionals_init' ) ) {
		/**
		 * Initialize the class.
		 */
		function digicart_CMB2_Conditionals_init() {
			static $digicart_CMB2_Conditionals = null;
			if ( null === $digicart_CMB2_Conditionals ) {
				$digicart_CMB2_Conditionals = new digicart_CMB2_Conditionals();
			}

			return $digicart_CMB2_Conditionals;
		}
	}
